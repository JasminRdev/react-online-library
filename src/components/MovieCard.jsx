...
function MovieCard({movie}){
    ...
    //     background: "green"
    // };
    const {isFav, addFav, removeFav, addNote, getNoteText, removeNote} = useMovieContext()
    ...
    // console.log(error, loading, note, notes, removeNote)
    ...
    return <div className={noteEditActive ? 'movie-card modal-open' : 'movie-card'}>
        ...
        <div className="movie-polster">
            ...
            <div className="movie-overlay">
                <button className={fav ? 'fav-btn fav--active' : 'fav-btn'} onClick={onFavClick}>
